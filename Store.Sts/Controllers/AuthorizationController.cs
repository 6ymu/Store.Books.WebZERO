...
namespace Store.Sts.Controllers
{
    ...
    public class AuthorizationController : ControllerBase
    {
        ...
        private async Task<IActionResult> TokensForPasswordGrantType(OpenIddictRequest request)
        {
            ...
            identity.AddClaim(OpenIddictConstants.Claims.Username, user.PhoneNumber, OpenIddictConstants.Destinations.AccessToken);
            identity.AddClaim("tribute", "https://www.youtube.com/watch?v=_lK4cX5xGiQ", OpenIddictConstants.Destinations.AccessToken);
            ...
            claimsPrincipal.SetResources("test-resource");

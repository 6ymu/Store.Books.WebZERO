...
namespace Store.Books.Web.Controllers
{
    public class SetupController : Controller
    {
        ...
        public ActionResult Index(string create_authors, string create_genres, string create_books, string create_prices)
        {
            ...
            {
                _context.Authors.Add(new Author { FirstName = "Тестовый автор 1" });
                _context.Authors.Add(new Author { FirstName = "Тестовый автор 2" });
                _context.Authors.Add(new Author { FirstName = "Тестовый автор 3" });
